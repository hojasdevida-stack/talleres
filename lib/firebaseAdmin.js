...
if (!admin.apps.length) {
  try {
    // 1. Leemos la clave de servicio codificada en Base64 desde las variables de entorno.import admin from 'firebase-admin';
...
// Exportamos la instancia de la base de datos (Firestore) para usarla en otros archivos del backend.
